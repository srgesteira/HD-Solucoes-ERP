...
export default function InventoryAdjustPage() {
  ...
  const loadBalances = useCallback(async (productId: string) => {
    setLoadingRow(true);
    try {
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm">
          <p className="text-slate-600 dark:text-slate-400">
            Digite código ou descrição (ou use a lupa). A alteração da
            quantidade em mão gera um movimento de ajuste no extrato; reservado
            e pontos de encomenda actualizam o cadastro.
          </p>
          <div className="space-y-1.5">
            ...
            <ProductComboboxField
              ...
              onChange={(hit) => {
                setSelected(hit);
                if (hit) void loadBalances(hit.id);
                else {
                  setQty("");
                  setReserved("");
                  setReorderPt("");
              ...
              catalogTitle="Seleccionar produto"
            ...
            <div className="space-y-4 border-t border-slate-200 pt-4 dark:border-slate-800">
              {loadingRow ? (
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="rp">Ponto de reposição</Label>
                    <Input
                      id="rp"
                      inputMode="decimal"
                      value={reorderPt}
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="rq">Qtd. reposição</Label>
                    <Input
                      id="rq"
                      inputMode="decimal"
                      value={reorderQty}
