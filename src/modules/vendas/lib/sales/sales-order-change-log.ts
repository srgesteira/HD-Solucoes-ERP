...
export const SALES_ORDER_FIELD_LABELS: Record<string, string> = {
  ...
  delivery_address_different: "Entrega em endereço diferente",
  delivery_street: "Entrega (rua)",
  delivery_number: "Entrega (número)",
  delivery_complement: "Entrega (complemento)",
  delivery_neighborhood: "Entrega (bairro)",
  delivery_city: "Entrega (cidade)",
  delivery_state: "Entrega (UF)",
  delivery_zip: "Entrega (CEP)",
