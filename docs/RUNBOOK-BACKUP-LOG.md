...
|------|------|---------------|-----------|
| 2026-06-17 | Smoke automatizado produção (`pnpm test:smoke:full`) | Agente Cursor | **55/55 OK** — DB, APIs, scripts unitários |
...
| 2026-06-17 | Migrations pendentes (`supabase db push`) | Agente Cursor | ✅ `20261003100000` + `20261004100000` (drop HVAC) aplicadas no remoto |
...
Checklist: frentes 1–7 em [`GUIA-EXECUCAO-CURSOR.md`](./GUIA-EXECUCAO-CURSOR.md) + §12.5 em [`GUIA-SISTEMA-LAYOUT-E-FUNCIONAMENTO.md`](./GUIA-SISTEMA-LAYOUT-E-FUNCIONAMENTO.md).
